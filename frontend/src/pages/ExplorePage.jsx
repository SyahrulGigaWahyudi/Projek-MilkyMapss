          ...
          <div className="mm-explore-map">
            ...
            >
              ...
              {selectedCampus?.latitude && (
                <>
                  <Circle center={selectedCampus.latitude ? [Number(selectedCampus.latitude), Number(selectedCampus.longitude)] : mapCenter} radius={300} pathOptions={{ color: '#ff5f00', fillColor: '#ff5f00', fillOpacity: 0.05 }} />
